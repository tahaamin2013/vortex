            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Unified Inbox</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Combine messages from WhatsApp, Instagram, Facebook Messenger, Telegram, and your website into one
                      centralized inbox.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Cross-Channel Continuity</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Continue conversations across channels without losing context. Your customers can start on
                      WhatsApp and continue on your website seamlessly.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">24/7 Auto-Reply</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Enable 24/7 customer engagement without extra staff. Intelligent auto-replies handle common
                      queries and route complex issues to your team.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="w-full max-w-lg">
                    <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                      <div className="p-4">
                        <textarea
                          className="w-full min-h-[100px] bg-transparent border-none text-white placeholder:text-white/50 resize-none focus:outline-none text-base leading-relaxed"
                          placeholder="Hi! How can I help you today? I'm available 24/7..."
                          value={inputValue}
                          onChange={(e) => setInputValue(e.target.value)}
                          onKeyDown={handleKeyDown}
                        />
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Built-in Calendar</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Frictionless meeting bookings directly from chat conversations. Let customers schedule
                      appointments without leaving the conversation.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="relative w-full max-w-sm">
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                      <div className="text-white text-center mb-4">
                        ...
                        <p className="text-sm text-white/70">Pick a time that works for you</p>
                      </div>
                      <div className="grid grid-cols-7 gap-1 mb-4">
                        {["S", "M", "T", "W", "T", "F", "S"].map((day, i) => (
                          <div key={i} className="text-center text-xs text-white/50 p-1">
                            {day}
                          </div>
                        ))}
                      ...
                      <div className="space-y-2">
                        {["9:00 AM", "2:00 PM", "4:30 PM"].map((time, i) => (
                          <button
                            key={i}
                            className="w-full p-2 text-sm bg-white/10 hover:bg-[#e78a53] rounded transition-colors text-white"
                          >
                            {time}
                          </button>
                        ))}
