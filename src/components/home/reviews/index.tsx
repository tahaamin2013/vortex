  ...
  const REVIEWS_DATA = [
    {
      card: [
        {
          value:
            "Vortex is so easy to use I can’t help but wonder if it’s really doing the things the government expects me to do.",
          name: "Sheryl Berge",
    ...
    },
    {
      card: [
        {
          value:
            "The best part about Vortex is every time I pay my employees, my bank balance doesn’t go down like it used to. Looking forward to spending this extra cash when I figure out why my card is being declined.",
          name: "Sheryl Berge",
          prof: "CEO at Lynch LLC",
        ...
        {
          value:
            "There are so many things I had to do with my old software that I just don’t do at all with Vortex. Suspicious but I can’t say I don’t love it.",
          name: "Leland Kiehn",
          prof: "Founder of Kiehn and Sons",
    ...
    },
    {
      card: [
        {
          value:
            "I used to have to remit tax to the EU and with Vortex I somehow don’t have to do that anymore. Nervous to travel there now though.",
          name: "Sheryl Berge",
          prof: "CEO at Lynch LLC",
