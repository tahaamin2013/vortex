  ...
  const FAQ_DATA = [
    {
      card: [
        ...
        {
          title: "How do I apply for a job at Vortex?",
      ...
      card: [
        {
          ...
          text: "Vortex is just a software application, ultimately your books are your responsibility.",
        },
        {
          title:
            "Vortex sounds horrible but why do I still feel compelled to purchase?",
          text: "This is the power of excellent visual design. You just can’t resist it, no matter how poorly it actually functions.",
        },
        {
          title:
            "I found other companies called Vortex, are you sure you can use this name?",
